...
actor Keychain {
    ...
    ///   - synchronizesWithiCloud: A Boolean value indicating whether the item is synchronized with iCloud.
    static func makeStoreItemParameters(
        ...
        parameters[kSecAttrSynchronizable] = synchronizesWithiCloud
...
private extension KeychainItem {
    ...
    init(attributes: [CFString: Any]) {
        self.init(
            ...
            synchronizesWithiCloud: attributes[kSecAttrSynchronizable] as? Bool ?? false,
